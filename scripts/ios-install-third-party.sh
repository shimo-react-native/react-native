...
fetch_and_unpack glog-0.3.4.tar.gz https://github.com/shimo-react-native/glog/archive/v0.3.4.tar.gz d9c258ab38ede255aeef6e9cd89727189201e491 "\"$SCRIPTDIR/ios-configure-glog.sh\""
